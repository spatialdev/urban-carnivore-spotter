      ...
      <div className={classes.footerIconDiv}>
        <div className={classes.flexColumn}>
          <Button className={classes.footerIcons} style={{ float: 'left', marginLeft: '50px', color: history.location.pathname==='/'? '#3411ff': 'grey' }} >
            <MapIcon style={{ color: history.location.pathname==='/' || isTacoma? '#3411FF': 'grey' }} onClick={() => isTacoma? history.push('/tacoma'): history.push('/')}/>
            <p>Explore</p>
          </Button>
        </div>
        <div className={classes.flexColumn}>
          <Fab style={{backgroundColor: '#8acc25'}} aria-label="Add" className={classes.plusButton} size={"large"} onClick={() => isTacoma ? history.push('/tacoma/reports/create'): history.push('/reports/create')}>
        ...
        <div className={classes.flexColumn}>
          <Button className={classes.footerIcons} style={{ float: 'right', marginRight: '50px', color: history.location.pathname.includes('/resources')?
                '#3411FF': 'grey' }}
                  onClick={() => isTacoma? history.push('/tacoma/resources') : history.push('/resources')}>
